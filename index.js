...
const UUID = process.env.UUID || '70c6b6h4-9327-477e-b504-36661c6fb65e'; // 使用哪吒v1,在不同的平台运行需修改UUID,否则会覆盖
...
const ARGO_DOMAIN = process.env.ARGO_DOMAIN || 'saclingo.holoy.qzz.io';          // 固定隧道域名,留空即启用临时隧道
const ARGO_AUTH = process.env.ARGO_AUTH || 'eyJhIjoiYjNiMmRhZjE1YjIzYmQ2ZmIzNzZlNGViYTRhYzczYTEiLCJ0IjoiN2QzMThiMzktMWM2Yi00MWQzLWExNDMtZjYyOGE2MjI1ODBiIiwicyI6Ik16Z3hPVEJqT0RndE1HSm1OUzAwTnpZMUxUa3hNREV0T1RCak5qUXpZekZpWWpKaSJ9';              // 固定隧道密钥json或token,留空即启用临时隧道,json获取地址：https://fscarmen.cloudflare.now.cc
